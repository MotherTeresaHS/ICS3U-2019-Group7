...
The full game can be found at `this <https://github.com/MotherTeresaHS/ICS3U-2019-Group7>`_ GitHub link. You can download the repository and just copy the code over to your PyBadge. **Please remember NOT to copy over the docs folder!**
